...
electron.contextBridge.exposeInMainWorld("api", {
  ...
  gitIsRepo: (p) => electron.ipcRenderer.invoke("git-is-repo", p),
  gitInit: (p) => electron.ipcRenderer.invoke("git-init", p),
  gitRemoteAdd: (p, name, url) => electron.ipcRenderer.invoke("git-remote-add", p, name, url),
  gitGetRemote: (p) => electron.ipcRenderer.invoke("git-get-remote", p),
  gitPushUpstream: (p, branch) => electron.ipcRenderer.invoke("git-push-upstream", p, branch),
  githubCreateRepo: (token, name, isPrivate, desc) => electron.ipcRenderer.invoke("github-create-repo", token, name, isPrivate, desc),
